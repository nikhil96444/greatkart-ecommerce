...
def register(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            send_email.send() 
            #messages.success(request, 'Thank you for registering with you, We have sent you an vertification email to your email address. Kindly Verify.')
        ...
        if user is not None:
            try:
                ...
                if is_cart_item_exists:
                    ...
                    # get the cart itme from the users to access the product variation
